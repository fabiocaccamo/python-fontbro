...
-   Fix `get_name` and `get_names` crash with undecodable name records or without `name` table.
...
-   Refactor `Font` class moving its logic to dedicated modules (the `Font` public API is unchanged).
...
## [0.26.1](https://github.com/fabiocaccamo/python-fontbro/releases/tag/0.26.1) - 2026-01-09
-   Fix Windows compatibility by removing `curses` dependency. (by [@seproDev](https://github.com/seproDev))

## [0.26.0](https://github.com/fabiocaccamo/python-fontbro/releases/tag/0.26.0) - 2026-01-09
